...
create_report "synth_8_synth_report_utilization_0" "report_utilization -file cm3_core_wrapper_utilization_synth.rpt -pb cm3_core_wrapper_utilization_synth.pb"
