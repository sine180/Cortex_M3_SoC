...
HD_PWD='D:/sine/Desktop/IC/Preliminary/Cortex_M3_SoC/Vivado_Project/cm3_Soc.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log cm3_core_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cm3_core_wrapper.tcl -notrace
