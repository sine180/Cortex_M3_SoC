...
synth_design -top cm3_core_wrapper -part xc7z010clg400-1 -fanout_limit 400 -fsm_extraction one_hot -keep_equivalent_registers -resource_sharing off -no_lc -shreg_min_size 5


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef cm3_core_wrapper.dcp
create_report "synth_10_synth_report_utilization_0" "report_utilization -file cm3_core_wrapper_utilization_synth.rpt -pb cm3_core_wrapper_utilization_synth.pb"
