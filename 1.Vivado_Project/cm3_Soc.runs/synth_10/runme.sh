...
HD_PWD='D:/sine/Desktop/IC/Preliminary/Cortex_M3_SoC/Vivado_Project/cm3_Soc.runs/synth_10'
cd "$HD_PWD"
...
EAStep vivado -log cm3_core_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cm3_core_wrapper.tcl
